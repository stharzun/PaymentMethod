...
public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final RecyclerItemClickListener recyclerItemClickListener) {
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (child != null && recyclerItemClickListener != null && gestureDetector.onTouchEvent(e)) {
            recyclerItemClickListener.onItemClick(child, rv.getChildAdapterPosition(child));
        }
        return false;
    }
